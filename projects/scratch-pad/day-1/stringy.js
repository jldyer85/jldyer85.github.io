...
function length(string) {
   ...
   //use dot length to return string length
...
//concatenate strings w/ no space using dot join('') method   
    return args.join('');
...
function longest(stringOne, stringTwo) {
    // YOUR CODE BELOW HERE //
    //I: stringOne & stringTwo's lengths; O: return stringOne if length > stringTwo or vice versa; C:
